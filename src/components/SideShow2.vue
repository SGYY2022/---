    ...
    <img src="">
        ...
        <div class="overall">
            ...
            <div class="content">
                <!-- 轮播图片 -->
                <ul>
                    <li><img src="../assets/image/caihua .jpeg"></li>
                    <li><img src="../assets/image/yundonghui.jpeg"></li>
                    <li><img src="../assets/image/chizongzi.jpg "></li>
                    <li><img src="../assets/image/caoyueshui.jpg"></li>
                    <li><img src="../assets/image/xionghuangjiu2.jpg"></li>
                </ul>
                <!-- 轮播图的点 -->
                <ol>
                    <li></li>
